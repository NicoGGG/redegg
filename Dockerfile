...
RUN sed -i '71i \        print("Allauth Error:", request, provider_id, error, exception, extra_context)' /usr/local/lib/python3.11/site-packages/allauth/socialaccount/adapter.py
